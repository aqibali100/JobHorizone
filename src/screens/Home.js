        ...
        <div class="container">
          ...
          <div class="row mt-5 pt-4">
            <div class="col-md-3 mb-4">
              <div class="plateform-cards">
                <div class="card-flex d-flex gap-4">
          ...
          <div class="row mt-5">
            <div class="col">
              <Carousel className="custom-carousel">
                <Carousel.Item>
                  <div class="slider-card mt-5">
                    <div class="slider-card-text text-center">
